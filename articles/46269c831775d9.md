...
MCP Server についてはすでに Nix を用いて宣言的に管理する手法が存在しますが、まだ Agent Skills について管理する手法は見当たらないように思えました。非 Nix での手法としては OpenSkills なるものがあるらしいです。詳しくは調べる気になりませんでした（Nix ではないので）
